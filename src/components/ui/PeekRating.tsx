...
const SHAPES = { star: StarIcon, heart: FavouriteIcon, bolt: FlashIcon } as const;
...
export default function PeekRating({
  ...
  const starEls = useRef<(HTMLButtonElement | HTMLSpanElement | null)[]>([]);
  ...
  return (
    <div
      ...
      style={{
        ["--pr-active" as string]: activeColor,
        ["--pr-idle" as string]: idleColor,
        ["--pr-tip" as string]: tipColor,
        ["--pr-tip-text" as string]: tipTextColor,
        ["--pr-size" as string]: `${size}px`,
        ["--pr-gap" as string]: `${Math.round(size * 0.22)}px`,
        ["--pr-room" as string]: `${lift + tipRoom}px`,
        ["--pr-rise" as string]: `${riseDuration}ms`,
      }}
      ...
      >
        ...
        {Array.from({ length: count }, (_, i) => {
          ...
          return (
            <Star
              key={i}
              ref={(el: HTMLButtonElement | HTMLSpanElement | null) => {
